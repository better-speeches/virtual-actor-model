# Virtual Actor Model via Orleans
...
* [Akka.NET (F#): Functional actor with states example](https://github.com/iTKerry/akka-fsharp-sample)
* [Akka.NET (C#): Movie streaming example](https://github.com/iTKerry/akka-movie-streaming)
* [Akka.NET (F#): real world usage example](https://github.com/TG-OpenTTD/fsharp-ottd-admin)
